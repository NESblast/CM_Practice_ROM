...
; ; NES Ram Vars
; .BANK 0 SLOT "RAM_NES"
; .ORG $0E	PlayerState:	          ;If this value is equal to 8, the player can control Mario.
; .ORG $20	AirborneState:	        ;0 = standing on ground, 1 = jumping, 2 = falling

; .ORG $E2    Input:
; .ORG $E3    DelayedInput:

; .ORG $50	XSpeed:	                ;The horizontal speed that Mario is trying to go. This does not account for any external speed changes (moving platforms, slopes, etc.)
; .ORG $8F	YSpeed:	                ;The vertical speed that Mario is trying to go, positive down.
; .ORG $65	XPage:	                ;The horizontal screen page that Mario is currently on.
; .ORG $7A	XPixel:	                ;The horizontal pixel that Mario is at.
; .ORG $B9	YPixel:	                ;The vertical pixel that Mario is at. Higher value = lower on the screen.
